...
# Run it directly:
#   bash scripts/eval_divide_and_vote.sh
#
...
#          -J divvote -o logs/out.%j scripts/eval_divide_and_vote.sh
#
# Requires 1 GPU.

# Main-table defense — Divide-and-Vote (isolate each retrieved doc, ask the
# victim per-doc, majority-vote final answer) vs. CamoDocs.
...
EXP_ID_NUM=${EXP_ID_NUM:-eval_divide_and_vote-}
...
LOG_NAME=$EXP_ID_NUM-$EVAL_DATASET-$EVAL_MODEL_CODE-$MODEL_NAME_FOR_LOG-camodocs-divvote-M$M-rep$REPEAT_TIMES-$NOTE.log
