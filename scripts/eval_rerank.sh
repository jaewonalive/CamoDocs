...
#          -J rerank -o logs/out.%j scripts/eval_rerank.sh
#
# Requires 1 GPU.

# Main-table defense — Cross-encoder rerank (BAAI/bge-reranker-v2-m3,
# top-100 retrieve -> top-5 keep) vs. CamoDocs.
...
EXP_ID_NUM=${EXP_ID_NUM:-eval_rerank-}

EVAL_MODEL_CODE="contriever"
EVAL_DATASET="${EVAL_DATASET:-hotpotqa}"
SPLIT="${SPLIT:-test}"
TOP_K="100"          # rerank pulls 100 candidates, keeps top RERANKER_TOP_N
GPU_ID="0"
SCORE_FUNCTION="dot"
...
LOG_NAME=$EXP_ID_NUM-$EVAL_DATASET-$EVAL_MODEL_CODE-$MODEL_NAME_FOR_LOG-camodocs-rerank-M$M-rep$REPEAT_TIMES-$NOTE.log
