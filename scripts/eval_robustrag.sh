...
# Run it directly:
#   bash scripts/eval_robustrag.sh
#
...
#          -J robustrag -o logs/out.%j scripts/eval_robustrag.sh
#
# Requires 1 GPU.

# Main-table defense — RobustRAG (secure keyword-aggregation defense)
...
EXP_ID_NUM=${EXP_ID_NUM:-eval_robustrag-}
...
DEFEND_METHOD="robustrag_keyword"
REMOVAL_METHOD="none"
...
LOG_NAME=$EXP_ID_NUM-$EVAL_DATASET-$EVAL_MODEL_CODE-$MODEL_NAME_FOR_LOG-camodocs-robustrag-M$M-rep$REPEAT_TIMES-$NOTE.log
